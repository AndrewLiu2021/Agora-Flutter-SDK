...
@objc public class RtcChannelEvents: NSObject {
    ...
    @objc public static let RecordFrameEvent = "RecordFrameEvent"
    static let PlaybackFrameEvent = "PlaybackFrameEvent"
    ...
    static func toMap() -> Dictionary<String, String> {
        return [
            ...
            "RecordFrameEvent": RecordFrameEvent,
            "PlaybackFrameEvent": PlaybackFrameEvent,
        ]
    }
}
